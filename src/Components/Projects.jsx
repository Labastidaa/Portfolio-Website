...
const Projects = () => {
    return (  
        <div className='flex flex-col items-center justify-center w-[100%] h-auto'>
            <p className='flex justify-center text-white text-bold font-Inter font-bold text-[50px] pb-10'>Projects</p>

            <div className=' 
            md:flex-row md:space-x-[2%] md:space-y-[0px]
            w-[95%] flex space-y-[14px] flex-col '>
                
                <div className='flex items-center justify-center bg-white w-[100%] h-[380px] rounded-[50px]'>
